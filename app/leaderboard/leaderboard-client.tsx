...
export function LeaderboardClient({ entries, currentUserId }: LeaderboardClientProps) {
  ...
  const currentUserEntry = currentUserId ? entries.find(entry => entry.id === currentUserId) : null;
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-background via-zest-50 to-accent">
      <div className="w-full px-4 py-8">
          ...
          <Card className="border-primary/20 bg-gradient-to-br from-primary/5 to-transparent">
            <CardContent className="p-6">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="text-sm text-muted-foreground">Active Streakers</p>
          ...
          <Card className="mb-6 border-chart-3/20 bg-gradient-to-r from-chart-3/5 to-transparent">
            <CardContent className="p-4">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="text-sm font-medium">Don&apos;t see your account?</p>
                  <p className="text-sm text-muted-foreground">
                    Make sure your profile is public to appear on the leaderboard.
                  </p>
                </div>
        ...
        {/* Leaderboard */}
        <div ref={leaderboardRef} className="space-y-3 leaderboard-scroll max-h-[600px] overflow-y-auto" style={{ scrollbarWidth: 'none', msOverflowStyle: 'none' }}>
                ...
                >
                  <CardContent className="p-4">
                    <div className="flex items-center gap-4">
                      {/* Rank */}
                      <div className={`flex items-center justify-center w-12 h-12 rounded-full ${getRankBadgeColor(rank)}`}>
                        {getRankIcon(rank)}
                      </div>
                      ...
                      <div className="text-right">
                        <div className="flex items-center gap-1 mb-1">
                          <span className={`text-2xl ${getStreakClass(entry.currentStreak)}`}>
        ...
        <div className="mt-12 text-center">
          <Card className="inline-block border-primary/20 bg-gradient-to-r from-primary/5 to-zest-100/50">
            <CardContent className="p-6">
              ...
              <p className="text-sm text-muted-foreground">
                Every streak counts. Stay consistent and watch yourself climb the ranks! 🚀
              </p>
            </CardContent>
          </Card>
        </div>
