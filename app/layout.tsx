...
export const metadata: Metadata = {
	...
	openGraph: {
		...
		description:
			"Transform your productivity with Z3st Habits. The citrus-powered habit system that adapts to your energy, celebrates wins, and builds momentum without burnout.",
