		...
		<Card className="border-border/60 bg-background/95 shadow-sm">
			<CardHeader className="space-y-1">
				<div className="flex items-center justify-between">
					...
					<Badge
						variant={entitlements?.tier === "free" ? "secondary" : "default"}
			...
			<CardContent className="pt-6 space-y-6">
				...
				{entitlements?.tier === "plus" && (
					<Alert className="border-orange-200 bg-orange-50 dark:border-sky-400/40 dark:bg-sky-500/10">
						<AlertTriangle className="h-4 w-4 text-orange-600 dark:text-sky-200" />
						<AlertTitle>Downgrading Your Plan</AlertTitle>
						<AlertDescription className="text-orange-800 dark:text-sky-100">
							If you downgrade to Pro or Free, we&apos;ll automatically remove
							excess habits, groups, and group members to fit your new plan
							limits.
							<br />
							<br />
							<strong>Oldest items will be removed first.</strong> We recommend
							reviewing your content before downgrading.
						</AlertDescription>
					</Alert>
				)}
